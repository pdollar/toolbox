...
// errs=mexFunction(data0, data1, wts0, wts1, nBins, prior, fids, ord0, ord1)
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  // get inputs
  int nBins, N0, N1, M0, M1, F; float prior, *wts0, *wts1;
  ...
  if( nrhs<9 ) M0=M1=0; else {
    ord0 = (uint32*) mxGetData(prhs[7]);
    ord1 = (uint32*) mxGetData(prhs[8]);
    M0 = (int) mxGetNumberOfElements(prhs[7]);
    M1 = (int) mxGetNumberOfElements(prhs[8]);
  }
