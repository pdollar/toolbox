...
% orientation. For Thomas' ECCV98 filters, use sig=sqrt(2), lam=4.
%
% USAGE
%
% INPUTS
...
% create even/odd pair (ppd version of Feven is the actual Gabor filter)
% instead of using cos and sin, masks y.^2.
[x,y]=meshgrid(-r:r,-r:r);
%Feven = -cos(2*pi*y/4 ) .* exp(-(y.^2)/(sig^2)-(x.^2)/(lam^2*sig^2)); %PPD
