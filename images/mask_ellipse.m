...
% inside of the specified ellipse.  The ellipse is given by 5 parameters,
% a semimajor axis of ra, a semminor axis of radius rb, angle phi (in
% radians), centered at (crow,ccol).
%
% An alternative method of specifying the ellipse parameters is in terms of
% the parameters of a 2d gaussian.  For more information on how a gaussian
% relates to an ellipse see gauss2ellipse.
% 
% USAGE
...
%  C       - 2x2 cov matrix
%  [d]     - [2] Number of std to create the ellipse to
%
% OUTPUTS
