...
% defined by angle_start and angle_size.  For example, using
% angle_start=-pi/4 and angle_size=pi/2 would give a quarter circle facing
...
% form a radius r circle. r may be either an integer, or an integer + .5.
% A pixel is considered to belong to the circle iff it is within the given
% angle and has a value strictly smaller then r.
% 
% USAGE
%  mask = mask_circle( angle_start, angle_size, r, [nsamples] )
%
% INPUTS
