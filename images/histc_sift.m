...
% wtMask, which should have the same exact dimensions as I.
%
% USAGE
%  hs = histc_sift( I, edges, parMask, [wtMask] )
%
% INPUTS
...
%  wtMask      - [] size(I) numeric array of weights
%
% OUTPUTS
...
%  hs = histc_sift( I, 5, {2,.6,.1,0} ); figure(1); im(hs)
%
...
function hs = histc_sift( I, edges, parMask, wtMask )

if( nargin<4 ); wtMask=[]; end;
hs = histc_sift_nD( I, edges, parMask, wtMask, 0 );
