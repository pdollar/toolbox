...
%
% This function has an additional parameter - supr_eq that causes a value
% in a given window to be suppressed unless it is the UNIQUE maximum in the
% window.  This is if supr_eq==1, then all locations that are not strictly
...
%
% USAGE
%  [subs,vals,keeplocs] = nonmaxsupr_list( subs, vals, radii, thresh, ...
%    maxn, supr_eq)
%
% INPUTS
