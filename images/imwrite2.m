...
%
% multflag controls how I is interpreted.  If multflag==0, then I is
...
% more info).
%
% If the directory specified by 'path' does not exist, imwrite2 attempts to
% create it.
%
% USAGE
%  I = imwrite2( I, multflag, imagei, path, name, ext, ndigits, varargin )
%
% INPUTS
...
function I = imwrite2( I, multflag, imagei, path, name, ext, ndigits, ...
  varargin )
